...
export const ON_EDIT_CUSTOMER_NAME = 'ON_EDIT_CUSTOMER_NAME';
...
export const SUCCEED_UPDATE_CUSTOMER = 'SUCCEED_UPDATE_CUSTOMER';
...
export const onEditCustomerName = (edittedCustomerName: string) => ({
  type: ON_EDIT_CUSTOMER_NAME as typeof ON_EDIT_CUSTOMER_NAME,
  payload: { edittedCustomerName },
});
...
export const succeedUpdateCustomer = (
  oldCustomerName: string,
  newCustomerName: string
) => ({
  type: SUCCEED_UPDATE_CUSTOMER as typeof SUCCEED_UPDATE_CUSTOMER,
  payload: { oldCustomerName, newCustomerName },
});
...
export type CustomersAction =
  ...
  | ReturnType<typeof onEditCustomerName>
  ...
  | ReturnType<typeof succeedUpdateCustomer>
